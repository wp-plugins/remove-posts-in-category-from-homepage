...
The option key is `remove-loop`;  all categories marked not to display in the main loop are stored in this option to keep the DB footprint as low as possible.
